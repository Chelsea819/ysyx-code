...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  //INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, temp = (uint64_t)src1*(uint64_t)src2, R(rd) = BITS(temp, 63, 32));
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, R(rd) = BITS(((uint64_t)(int32_t)src1 * (uint64_t)(int32_t)src2), 63, 32)) ;
