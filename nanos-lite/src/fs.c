...
size_t fs_read(int fd, void *buf, size_t len){
  ...
  printf("file_table[%d].disk_offset = 0x%08x file_offset[%d] = 0x%08x file_table[%d].size = 0x%08x",fd,file_table[fd].disk_offset,fd,file_offset[fd],fd,file_table[fd].size);
