...
void init_mem_npc(){
	...
	pmem[0] = 0b00000000000100000000000010010011; //addi    x[1] = 0 + 1     	80000000	100093
	pmem[1] = 0b00000000010000000000000100010011; //2   x[1] = 0 + 2 			80000004	400113	
	pmem[2] = 0b00000000000000000001010000010111; //auipc						80000008	
	pmem[3] = 0b00000000000000000010010000010111; //auipc						8000000c
	pmem[4] = 0b00000000000000000110000110110111; //lui							80000010
	pmem[5] = 0b00000000100000000000000011101111; //jal   x[1] = pc + 4 pc += 8 80000014
	pmem[6] = 0b00000000000000001110001110110111; //lui							80000018
	pmem[7] = 0b00000000000000011110011110110111; //lui							8000001c
	pmem[8] = 0b00000000100000000000000011101111; //jal   x[1] = pc + 4 pc += 8 80000020
	pmem[9] = 0b00000000111000000000001110010011; //addi x[3] = 0 + 6 			80000024
	pmem[10] = 0b00000001000000000000010000010011; //addi x[4] = 0 + 7			80000028
	pmem[11] = 0b00000000000000001010000111100111; //jalr  					    8000002c   x[3] = pc + 4 pc = x[1] + imm = 80000018 + 0
